...
class _SignUpPasswordScreenState extends State<SignUpPasswordScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ConstColumnSpacer(MediaQuery.of(context).viewInsets.bottom > 0 ? 1 : 5),
            Padding(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    ConstColumnSpacer(MediaQuery.of(context).viewInsets.bottom > 0 ? 2 : 5),
                    MainButton(
                        onpressed: (){
                            if (_formKey.currentState!.validate()) {
                            
                       pushScreen(context,ScreenRoutes.toSignUpPersonalDetailsScreen);
  ...
  String? validateConformPassword(String? confrompassword,) {
    if (!ValidationUtil().validateNotEmpty(confrompassword)) {
      return "Conform password_required";
    }

 
    if (ValidationUtil().validateNotEmpty(_passwordController.text)&&confrompassword !=_passwordController.text  ) {
